...
<div class="row w-100">
  ...
  <div class="col-lg-4 col-sm-6 col-12 p-lg-3">
    <div class="card shadow w-100 text-dark">
         ...
         <h4>{{$item->title}}
          <div class="dropdown float-lg-right">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="{{url('user/project/messages/'.$item->id.'/'.$item->invoice_number)}}">Inbox</a>
      ...
      <span style="font-size: 25px; font-weight:bold; color:green">{{$item->price}}</span>
      </span>
      </div>
